...
I created a handy VSCode config that allows me to autoformat Typescript code on save, and also show ESLint errors in the UI with yellow squiggly lines, so that I don't miss them. #javascript #eslint #vite #p
