...
#### bunster
[GitHub - yassinebenaid/bunster: Compile shell scripts to static binaries.](https://github.com/yassinebenaid/bunster)
...
I played around with this for a bit. I am not sure if I will use it for anything, but the code for the "runtime" was an interesting deep-dive 