...
The actual plugin is here: [GitHub - deepakjois/nvim-postit: capture post-it like notes with nvim](https://github.com/deepakjois/nvim-postit). I mainly wrote it to scratch a tiny itch I had and also to try out the Composer feature to see how functional it was in helping me build entire projects. Overall, the experience was a bit mid 
