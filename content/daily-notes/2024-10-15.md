...
In the cafe conversation, Cyril demoed a combination of [Stremio](https://www.stremio.com/), the [Torrentio - Stremio Addon](https://torrentio.strem.fun/configure) and [Real-Debrid: All-in-one solution](https://real-debrid.com/) that just worked seamlessly. There is a guide on reddit that provides dead simple instructions to set it up: [Stremio + Torrentio + Debrid: A How-To Guide](https://www.reddit.com/r/StremioAddons/comments/15agu2p/stremio_torrentio_debrid_a_howto_guide/)
...
5. The Real Debrid service downloads the torrent to its cloud servers.
