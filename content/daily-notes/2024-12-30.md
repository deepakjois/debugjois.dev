...
The first thing I was doing slightly wrong was that I was installing `dotnet` instead of `dotnet-sdk`

I realised the correct way to install multiple versions of `dotnet-sdk on OS X
