...
I recently wrote a CSS grid based Game of Life animation, that served as a background for a webpage. Had a lot of fun writing it. But when I showed the webpage to a bunch of my dev friends, I was a bit surprised how few of them