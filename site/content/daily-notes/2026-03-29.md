...
#### Website Tweaks
[Commits · deepakjois/debugjois.dev · GitHub](https://github.com/deepakjois/debugjois.dev/commits/main?since=2026-03-29&until=2026-03-30)

In a frenzied bout of Sunday vibe coding (with breaks to grab an [amazing Banh Mi sandwich](https://saveur-banhmi.com/berlin/) and watch an [observational documentary](https://www.imdb.com/title/tt35973227/)  at the Greek Film Festival in Babylon), I managed to overhaul my website to be able to sync cleanly, and edit it from both my Obsidian Vault on the desktop, and a web based UI on my mobile phone.
